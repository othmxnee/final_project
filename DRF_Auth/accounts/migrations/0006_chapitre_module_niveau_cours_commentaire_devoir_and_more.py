...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0005_delete_uploadedfile_remove_user_auth_provider'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Chapitre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.chapitre')),
            ],
        ),
        migrations.CreateModel(
            name='Commentaire',
        ...
        migrations.AddField(
            model_name='module',
            name='Promotion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.promo'),
        ),
        migrations.CreateModel(
            name='Ressource',
            fields=[
